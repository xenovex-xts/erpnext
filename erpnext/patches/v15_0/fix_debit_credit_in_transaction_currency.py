...
def execute():
	...
	frappe.db.sql(
        ...
        UPDATE `tabGL Entry`
        SET
            debit_in_transaction_currency = CASE WHEN transaction_currency = account_currency THEN debit_in_account_currency ELSE debit / transaction_exchange_rate END,
            credit_in_transaction_currency = CASE WHEN transaction_currency = account_currency THEN credit_in_account_currency ELSE credit / transaction_exchange_rate END
        WHERE
