	...
	def set_landed_cost_voucher_amount(self):
		for d in self.get("items"):
			...
			query = (
				...
				# The caller reads a single row (total charges + one cost_center), so
				# MAX()-wrap cost_center rather than grouping by it, which PG requires
				# for the bare column and which keeps the SUM a single total.
